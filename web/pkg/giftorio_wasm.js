...
export function set_progress_callback(callback) {
    wasm.set_progress_callback(callback);
}
...
export function run_blueprint(gif_data, use_dlc, signals_json, target_fps, max_size, substation_quality) {
    ...
    try {
        ...
        const ptr1 = passStringToWasm0(signals_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('giftorio_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
